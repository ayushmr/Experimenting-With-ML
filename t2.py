...
#for i in range(t):
    #if(get_pred(x[40000+i])==label_in[40000+i]):
        #sum=sum+1
        #continue
    #else:
        #w=train(x[i+40000],y[40000+i],w)

#test
for i in range (10000):
    test=[]
    print(get_pred(out_img[i]),out_label[i])
    #test_pre=np.array(test).reshape(1,10000)
    #test_pred[i]=(get_pred(out_img[i]))
